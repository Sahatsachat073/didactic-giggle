        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">ผลสอบภาษา /</span> แก้ไขผลการสอบ</h4>
                  ...
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                      <?php
                            ...
                            $strSQL = "SELECT * FROM info_result_language_exam WHERE id = '".$_GET["id"]."' ";
                      ...
                      <form action="./process-edit-language-exam.php?id=<?php echo $_GET["id"];?>" method="POST" name="update">
                        <div class="row">
                          <!-- HTML5 Inputs -->
                            ...
                            <h3 class="card-header">แก้ไขผลการสอบ</h3>
                            <div class="card-body">
                              <div class="mb-3 row">
                              ...
                              <div class="mb-3 row">
                                ...
                                <div class="col-md-2">
                                  <input name="score" class="form-control" type="text" value="<?php echo $row["score"]?>" />
                                </div>
                              </div>
                              ...
                              <div class="mb-3 row">
                                ...
                                <div class="col-md-3">
                                  <input name="term" class="form-control" type="text" value="<?php echo $row["term"]?>" id="html5-text-input" />
                                </div>
                                <label for="html5-text-input" class="col-md-2 col-form-label">
                                  <h5>ปีการศึกษา</h5>
                                  </label>
                                <div class="col-md-3">
                                  <input name="years" class="form-control" type="text" value="<?php echo $row["years"]?>" id="html5-text-input" />
                                </div>
                              </div>
